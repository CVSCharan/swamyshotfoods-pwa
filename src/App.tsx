...
const ProtectedRoute: React.FC<ProtectedRouteProps> = ({ children, allowedRoles }) => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-neutral-50 flex flex-col items-center justify-center text-neutral-500 font-display">
        <svg className="animate-spin h-8 w-8 text-saffron-500 mb-4" fill="none" viewBox="0 0 24 24">
